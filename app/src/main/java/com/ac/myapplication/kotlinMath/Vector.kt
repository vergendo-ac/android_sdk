...
data class Float2(var x: Float = 0.0f, var y: Float = 0.0f) {
    ...
    operator fun get(index1: Int, index2: Int) =
        Float2(get(index1), get(index2))
    ...
    inline operator fun plus(v: Float) =
        Float2(x + v, y + v)
    inline operator fun minus(v: Float) =
        Float2(x - v, y - v)
    inline operator fun times(v: Float) =
        Float2(x * v, y * v)
    inline operator fun div(v: Float) =
        Float2(x / v, y / v)

    inline operator fun plus(v: Float2) =
        Float2(x + v.x, y + v.y)
    inline operator fun minus(v: Float2) =
        Float2(x - v.x, y - v.y)
    inline operator fun times(v: Float2) =
        Float2(x * v.x, y * v.y)
    inline operator fun div(v: Float2) =
        Float2(x / v.x, y / v.y)
...
inline operator fun Float.plus(v: Float2) =
    Float2(this + v.x, this + v.y)
inline operator fun Float.minus(v: Float2) =
    Float2(this - v.x, this - v.y)
inline operator fun Float.times(v: Float2) =
    Float2(this * v.x, this * v.y)
inline operator fun Float.div(v: Float2) =
    Float2(this / v.x, this / v.y)

inline fun abs(v: Float2) =
    Float2(abs(v.x), abs(v.y))
...
inline fun lessThan(a: Float2, b: Float) =
    Bool2(a.x < b, a.y < b)
inline fun lessThan(a: Float2, b: Float2) =
    Bool2(a.x < b.x, a.y < b.y)
inline fun lessThanEqual(a: Float2, b: Float) =
    Bool2(a.x <= b, a.y <= b)
inline fun lessThanEqual(a: Float2, b: Float2) =
    Bool2(a.x <= b.x, a.y <= b.y)
inline fun greaterThan(a: Float2, b: Float) =
    Bool2(a.x > b, a.y > b)
...
inline fun greaterThanEqual(a: Float2, b: Float2) =
    Bool2(a.x >= b.x, a.y >= b.y)
inline fun equal(a: Float2, b: Float) =
    Bool2(a.x == b, a.y == b)
inline fun equal(a: Float2, b: Float2) =
    Bool2(a.x == b.x, a.y == b.y)
inline fun notEqual(a: Float2, b: Float) =
    Bool2(a.x != b, a.y != b)
inline fun notEqual(a: Float2, b: Float2) =
    Bool2(a.x != b.x, a.y != b.y)

inline infix fun Float2.lt(b: Float) =
    Bool2(x < b, y < b)
inline infix fun Float2.lt(b: Float2) =
    Bool2(x < b.x, y < b.y)
inline infix fun Float2.lte(b: Float) =
    Bool2(x <= b, y <= b)
inline infix fun Float2.lte(b: Float2) =
    Bool2(x <= b.x, y <= b.y)
inline infix fun Float2.gt(b: Float) =
    Bool2(x > b, y > b)
inline infix fun Float2.gt(b: Float2) =
    Bool2(x > b.x, y > b.y)
inline infix fun Float2.gte(b: Float) =
    Bool2(x >= b, y >= b)
inline infix fun Float2.gte(b: Float2) =
    Bool2(x >= b.x, y >= b.y)
inline infix fun Float2.eq(b: Float) =
    Bool2(x == b, y == b)
inline infix fun Float2.eq(b: Float2) =
    Bool2(x == b.x, y == b.y)
inline infix fun Float2.neq(b: Float) =
    Bool2(x != b, y != b)
...
inline fun abs(v: Float3) =
    Float3(abs(v.x), abs(v.y), abs(v.z))
...
inline infix fun Float3.lt(b: Float) =
    Bool3(x < b, y < b, z < b)
inline infix fun Float3.lt(b: Float3) =
    Bool3(x < b.x, y < b.y, z < b.z)
inline infix fun Float3.lte(b: Float) =
    Bool3(x <= b, y <= b, z <= b)
inline infix fun Float3.lte(b: Float3) =
    Bool3(x <= b.x, y <= b.y, z <= b.z)
inline infix fun Float3.gt(b: Float) =
    Bool3(x > b, y > b, z > b)
inline infix fun Float3.gt(b: Float3) =
    Bool3(x > b.x, y > b.y, z > b.z)
inline infix fun Float3.gte(b: Float) =
    Bool3(x >= b, y >= b, z >= b)
inline infix fun Float3.gte(b: Float3) =
    Bool3(x >= b.x, y >= b.y, z >= b.z)
inline infix fun Float3.eq(b: Float) =
    Bool3(x == b, y == b, z == b)
inline infix fun Float3.eq(b: Float3) =
    Bool3(x == b.x, y == b.y, z == b.z)
inline infix fun Float3.neq(b: Float) =
    Bool3(x != b, y != b, z != b)
...
inline infix fun Float4.lt(b: Float) =
    Bool4(x < b, y < b, z < b, a < b)
...
inline infix fun Float4.gt(b: Float) =
    Bool4(x > b, y > b, z > b, w > b)
